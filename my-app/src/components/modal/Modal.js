...
const Modal = ({ open = false, handleClose = () => {} }) => {
  ...
  return ReactDOM.createPortal(
    <div
      className={`modal fixed flex inset-0 z-50 items-center
     p-5 justify-center ${open ? "" : "opacity-0 invisible"}`}
    >
      {/* lop phủ */}
      <div
        onClick={handleClose}
  ...
  return (
    <>
      ...
      <button
        ...
        className="m-6 p-4 bg-orange-300 rounded-lg"
      >
        Show modal
      </button>
      <div className="relative z-30">
        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Incidunt,
        deserunt assumenda dolorum delectus autem vero eius, ipsam illo dolorem
        reiciendis et. Quisquam deleniti ullam aliquam nobis eum laudantium.
        Molestias, et.
      </div>
